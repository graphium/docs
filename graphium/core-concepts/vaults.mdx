...
A vault is the central organizing unit in Graphium AI. Think of it as a project workspace -- a single container that holds your data tables, AI assistants, playbooks, tasks, and connections to external systems, all scoped to a specific purpose.
...
- **Builder** -- Can create and modify tables, forms, and playbooks. Cannot manage users or delete the vault.
