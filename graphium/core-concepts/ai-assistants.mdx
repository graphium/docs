...
When you create a new assistant, you'll work across three configuration tabs: General, Tools, and Channels.
...
The Channels tab lets you deploy the assistant as a bot on external communication platforms such as Microsoft Teams, Slack, or SMS, so users can interact with the assistant without opening Graphium directly.
