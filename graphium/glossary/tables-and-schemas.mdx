...
Graphium supports a range of property (field) types to model different kinds of data. Here is each type with a practical example from healthcare practice management.
...
A *parent* Object property acts as a container that groups related *child* properties (sub-fields) together, creating the hierarchical nesting that makes Graphium schemas more expressive than flat spreadsheets. A *parent* Object property does not hold data itself — it organizes related *child* properties together.
