...
Start with a blank vault and build your own tables, schemas, and playbooks from the ground up. Define your tables, add fields, configure connections, and shape the vault to fit your use case -- whether you are tracking cases, managing schedules, or monitoring compliance.

**Explore a Sample Vault.** If you are new to Graphium and want to see how things work before committing to a setup, open a Sample Vault. These come pre-loaded with demo data -- actual records in the tables, pre-configured playbooks, example tasks -- so you can browse around, ask the AI assistant questions, and get a feel for the platform without touching real data.
...
**Connections** -- Links to external systems (EMR, spreadsheets, file servers, etc.), with a count badge. This is where you manage your Epic connection, your FTP sync, and any other external integrations.
