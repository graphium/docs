...
description: "The **Default Table Properties** setting controls which fields appear as columns when someone opens a table in the Data view, and the order those columns app..."
icon: "database"
---
