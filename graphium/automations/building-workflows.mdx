...
description: "Workflows in Graphium AI let you automate what happens after data is captured."
icon: "zap"
---
...
- [Using AI Assistants](/graphium/ai-assistants/using-ai-assistants)
- [Managing Tasks]
