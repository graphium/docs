...
3. Under **General**, scroll down to the **Danger Zone** section.

The Danger Zone is labeled in red and appears near the bottom of the **General** page, below the Vault details and Assistant table and column changes sections.
...
1. Open the vault and navigate to **Settings → General → Danger Zone**.
...
5. Under **General**, scroll to the **Danger Zone** section.
