---
title: "Understanding Vault Metadata"
description: "Each vault displays a small set of metadata — a **record count** and a **last updated date** — to give you a quick snapshot of the vault's activity without h..."
icon: "vault"
---
