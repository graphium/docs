---
title: "Adding a User to a Vault"
description: "Vault Admins can grant access to a vault by searching for a workspace member in the **Access & Permissions → Users** tab."
icon: "vault"
---
