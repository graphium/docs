...
description: "The Workspace Settings page lets Workspace Owners manage the identity and configuration of their workspace — including its name, description, and record dele..."
icon: "rocket"
---
